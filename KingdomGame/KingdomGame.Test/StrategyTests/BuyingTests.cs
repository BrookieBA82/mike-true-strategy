...
namespace KingdomGame.Test
{
    ...
    public class BuyingTests {
        ...
        public void TestEmptyScriptedCardBuy() {
            ...
            game.State.CurrentPlayer.Strategy.BuySelectionStrategy = new ScriptedBuySelectionStrategy(new List<CardType>());
            game.PlayPhase();
        ...
        public void TestSingleScriptedCardBuy() {
            ...
            Game game = TestSetup.GenerateStartingGame(2, gameCardCountsByTypeId, playerCardCountsByTypeId);
            TestUtilities.ForceGamePhase(game, Game.Phase.BUY);
            game.State.CurrentPlayer.Strategy.BuySelectionStrategy 
        ...
        public void TestMultipleScriptedCardBuys() {
            ...
            Game game = TestSetup.GenerateStartingGame(2, gameCardCountsByTypeId, playerCardCountsByTypeId);
            TestUtilities.ForceGamePhase(game, Game.Phase.BUY);
            game.State.CurrentPlayer.Strategy.BuySelectionStrategy = new ScriptedBuySelectionStrategy(
        ...
        public void TestSingleScriptedCardBuyNotPossible() {
            ...
            Game game = TestSetup.GenerateStartingGame(2, gameCardCountsByTypeId, playerCardCountsByTypeId);
            TestUtilities.ForceGamePhase(game, Game.Phase.BUY);
            game.State.CurrentPlayer.Strategy.BuySelectionStrategy = new ScriptedBuySelectionStrategy(new List<CardType>() {TestSetup.CardTypeEstate});
            game.PlayPhase();
        ...
        private static bool IsBuyingOptionValid(Game game, IList<CardType> buyingOption, int maxBuys) {
            ...
            clone.State.CurrentPlayer.Strategy.BuySelectionStrategy = new ScriptedBuySelectionStrategy(new List<CardType>(buyingOption));
